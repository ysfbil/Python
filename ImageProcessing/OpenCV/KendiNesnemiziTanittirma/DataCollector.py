#Pozitif ve negatif resim oluşturmak için
...
minBlur = 500  # SMALLER VALUE MEANS MORE BLURRINESS PRESENT (Kamera sallanınca oluşan bulanıklık durumlarında çekim yapmıyor)
